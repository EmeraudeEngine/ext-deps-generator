...
$CMAKE_OPTIONS += @{
	...
	"HB_HAVE_GLIB" = "Off"
	"HB_HAVE_ICU" = "Off"
	#"HB_HAVE_CORETEXT" = "Off" # Apple only
	"HB_HAVE_UNISCRIBE" = "On" # Windows only
	"HB_HAVE_GDI" = "On" # Windows only
	"HB_HAVE_DIRECTWRITE" = "On" # Windows only
	"HB_BUILD_UTILS" = "Off"
	"HB_BUILD_SUBSET" = "On"
	"HB_HAVE_GOBJECT" = "Off"
...
# Debug is ignored by CMake with Harfbuzz.
