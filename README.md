# External dependendencies builder

This repository aims to create a cross-platform archive of static libraries to usr with a project easily.
...
## brotli [master, ed738e842d2fbdf2d6459e39267a633c4a9b2f5d]
...
## bzip2 [master, 1ea1ac188ad4b9cb662e3f8314673c63df95a589]
...
## clipper2 [main, 6901921c4be75126d1de60bfd24bd86a61319fd0]
...
## cpu_features [main, 27a978c3070c88914e057b56cb2f9c8575d2fae2]
...
## cryptopp-cmake [master, 00a151f8489daaa32434ab1f340e6750793ddf0c]
...
## freetype [master, 42608f77f20749dd6ddc9e0536788eaad70ea4b5]
...
## harfbuzz [main, 3ef8709829a5884517ad91a97b32b9435b2f20d1]
...
## hwloc [v2.12, 023d11309beca9c68c7433e8d634f1999e25370c]
...
Notes :
	Linux and macOS versions are using autotools instead of cmake.

## lib3mf [release/2.4.1, 20c335489c69d15c64f3eaf1e15143b8176901f5]
...
Notes :
	This library fails to compile as static.

## libjpeg-turbo [main, adbb328159b5558e846690c49f9458deccbb0f43]
...
## libpng [libpng16, 872555f4ba910252783af1507f9e7fe1653be252]
...
## libsamplerate [master, 4858fb016550d677de2356486bcceda5aed85a72]
...
## libwebp [1.5.0, a4d7a715337ded4451fec90ff8ce79728e04126c]
...
## libzip [main, f30f5290de485348442d168cd7b2eb714d1f20f9]
...
Notes :
	On Windows, you need to add "PATHS LIBS_ROOT" inside find_package() functions in the CMakeLists.txt before compiling.

## libzmq (ZeroMQ) [master, 622fc6dde99ee172ebaa9c8628d85a7a1995a21d]
...
## cppzmq [master, 21c83ca0c3d8c11d81aa13aca2a565607a25920b]
...
Notes : 
	There is no compilation here, this is just some headers for libzmq.

## openal-soft [master, 90191edd20bb877c5cbddfdac7ec0fe49ad93727]
...
## taglib [master, e3de03501ff66221d1f1f971022b248d5b38ba06]
...
## xz (LZMA) [v5.6, ac50df0d89ce73f30430b8174e578071cbb4e056]
...
## zlib [master, 51b7f2abdade71cd9bb0e7a373ef2610ec6f9daf]
...
Usage : Compression library.
Notes : 
	This version build the static and the shared libraries, beware when linking.
	An upcoming release will fix this with cmake options.

## zstd [release, f8745da6ff1ad1e7bab384bd1f9d742439278e99]
...
"builds" directory will contains the compilation files.
"output" directory will contains the final library files to ship.
